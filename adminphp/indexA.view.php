                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading">Inicio de Sesión</div>
                            <a class="nav-link collapsed" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                                <a class="sb-nav-link-icon" style="text-decoration: none; color: white; margin-left: 10px;" href="../index.php"><i class="fas fa-sign-in-alt"></i>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Has iniciado sesión como Administrador y tienes los privilegios correspondientes.</li>
                        </ol>
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body" style="font-size: 30px;"><i class="fas fa-plus-square"></i> Añadir Usuario</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="crearUsuario.php"></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-4">
                            <div class="col-xl-12 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body" style="font-size: 30px;"><i class="fas fa-database"></i> Consulta de Datos</div>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $fila['years'] ?></td>
                                             <td><?php echo "<a href='editarUsuario.php?id=".$fila['name']."'><img src='../images/icons8-Edit-32.png' alt='editar'></a>"; ?></td>
                                            <td><?php echo "<a href='eliminarUsuario.php?id=".$fila['name']."'><img src='../images/icons8-Trash-32.png' alt='Eliminar'></a>"; ?></td>
