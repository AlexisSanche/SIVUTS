                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                                <a class="sb-nav-link-icon" style="text-decoration: none; color: white; margin-left: 10px;" href="indexU.view.php"><i class="fas fa-angle-left"></i>
                                Regresar</a>
                ...
                <div class="card mb-4">
                            <div class="col-xl-12 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body" style="font-size: 30px;"><i class="fas fa-check"></i> Vota por un Proyecto</div>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $fila['fecha'] ?></td>
                                             <td><?php echo "<a href='recibirvoto.php?like=".$fila['titulo']."'><img src='images/voto-positivo.png' alt='editar'></a>"; ?></td>
